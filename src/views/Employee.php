  ...
  <div class="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-8">
    ...
    <aside class="md:w-1/4 w-full p-6 bg-gray-900 rounded-xl shadow-lg border border-gray-700">
      ...
      <ul class="space-y-6 text-gray-400">
        <li>
          <a href="<?=$_ENV['BASE_URL'].'/employees/dashboard'?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-800 transition duration-300 transform hover:scale-105">
        ...
        <li>
          <a href="<?=$_ENV['BASE_URL'].'/tasks/dashboard'?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-800 transition duration-300 transform hover:scale-105">
